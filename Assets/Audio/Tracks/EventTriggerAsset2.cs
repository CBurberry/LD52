...
public class EventTriggerAsset2 : PlayableAsset
{
    ...
    {
        var playable = ScriptPlayable<EventTriggerBehaviour2>.Create(graph);
...
public class EventTriggerBehaviour2 : PlayableBehaviour
{
